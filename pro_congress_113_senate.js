...
//    var fullNameArray = [];
//    for(var i = 0; i < object.results[0].members.length; i++){
//        if (object.results[0].members[i].middle_name == null){
//            fullNameArray.push("<tr><td>" + object.results[0].members[i].last_name + ' ' + object.results[0].members[i].first_name + "</td></tr>");
//        } else {
//            fullNameArray.push("<tr><td>" + object.results[0].members[i].last_name + ' ' + object.results[0].members[i].middle_name + ' ' + object.results[0].members[i].first_name + "</td></tr>");
//            }
//        }
